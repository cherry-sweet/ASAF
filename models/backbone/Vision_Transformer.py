...
from timm.models import (
    build_model_with_cfg, resolve_pretrained_cfg, named_apply,
    adapt_input_conv, checkpoint_seq, register_model
)
...
def vit_backbone(**kwargs):
	...
	model_kwargs = dict(patch_size=16, embed_dim=768, depth=12, num_heads=12,
	                    img_size=448, global_pool='avg', class_token=False, **kwargs)   # 448
