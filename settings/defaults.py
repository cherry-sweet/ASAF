...
_C.data.data_root = '/media/data/zpp/mycode/MPSA/DATA'
_C.data.img_size = 484
...
_C.model.pretrained = ''  # /media/data/zpp/baseline2/pretrained
_C.model.pre_version = ''
_C.model.pre_suffix = '.pth'
# _C.model.mps_pretrained = '/media/data/zpp/baseline2/pretrained/Swin Base.pth'
_C.model.resume = ''#'/media/data/zpp/baseline2/output/cub/最新/checkpoint.bin'  #'/media/data/zpp/baseline2/output/cub/baseline/checkpoint.bin'
...
# -----------------------------------------------------------------------------
_C.distribute = CN()
_C.distribute.multiprocessing_distributed = True
_C.distribute.world_size = 1
_C.distribute.rank = -1
_C.distribute.dist_url = "tcp://localhost:10001"
_C.distribute.dist_backend = "nccl"
_C.distribute.gpu = 4
